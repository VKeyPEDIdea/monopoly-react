...
import { decreasePlayersCashCount, increasePlayersCashCount } from '../playersSlice';

const payForTransfer = (price: number, playerId: number, destination: number | null) => (dispatch: AppDispatch, getState: () => RootState) => {
