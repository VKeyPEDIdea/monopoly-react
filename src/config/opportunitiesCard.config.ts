...
export const CHANCE_LIST: Opportunities[] = [
  ...
  },
  {
    ...
    targetSector: 24,
    detailsText:
      'Вы поехали в ресторан, чтобы пообедать с друзьями. Если вы проходите Старт, получите 200',
  ...
  },
  {
    ...
    chanceTitle: CHANCE_TITLE,
    detailsText:
      'Вашим зданиям требуются капитальный ремонт. Оплатите 25 за каждый дом и 100 за каждый отель',
    isNegative: true,
  ...
  },
  {
    ...
    targetSector: 15,
    detailsText:
      'Вас ждет поездка. Отправляйтесь в северный морской порт. Если вы проходите Старт, получите 200',
  ...
  },
  {
    ...
    chanceTitle: CHANCE_TITLE,
    detailsText:
      'Освобождение из тюрьмы. Карта может быть использована или продана',
    btnText: 'Взять карту',
  },
];
...
export const BANK_LIST: Opportunities[] = [
  ...
  },
  {
    ...
    chanceTitle: BANK_TITLE,
    detailsText:
      'Освобождение из тюрьмы. Карта может быть использована позже или продана',
    btnText: 'Взять карту',
  },
  {
    type: 'balance',
    chanceTitle: BANK_TITLE,
    detailsText:
      'Вы получили наследство. Какие-то далекие родственники завещали вам свои сбережения',
    count: 100,
    isNegative: false,
    btnText: 'Получите',
  },
  ...
  },
  {
    ...
    chanceTitle: BANK_TITLE,
    detailsText:
      'Вы арестованы. Кто-то подставил вас - скорее всего безжалостные конкуренты',
  ...
  },
  {
    ...
    chanceTitle: BANK_TITLE,
    detailsText:
      'Вы выгодно продали один из своих бизнесов. Он только отвекал вас',
    count: 50,
    isNegative: false,
