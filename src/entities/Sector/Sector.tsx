...
const Sector = memo(
  ({
    ...
    const sectorStyles = `${classes.sector} ${
      isShowToOwner ? classes['sector--owner'] : ''
    }`;
    ...
    if (type !== 'LandPlot') {
      return (
        <div
          ref={sector}
          className={[
            type === 'TransportCompany' ? sectorStyles : classes.sector,
            classes['sector--simple'],
          ].join(' ')}
          data-sector-id={id}
        >
          ...
          <p
            className={[
              classes['step-count'],
              classes[`step-count--${line === 'Top' ? 'top' : 'bottom'}`],
            ].join(' ')}
          >
            {stepCount}
          </p>
      ...
      return (
        <div ref={sector} className={sectorStyles} data-sector-id={id}>
          ...
          <div className={classes.meta}>
            <p className={`${classes.title} ${classes['title--bottom']}`}>
              {title}
            </p>
            <p className={`${classes.price} ${classes['price--bottom']}`}>
              {price}
            </p>
          </div>
          <p
    ...
    return (
      <div ref={sector} className={sectorStyles} data-sector-id={id}>
        ...
        <p
          className={[classes['step-count'], classes['step-count--top']].join(
            ' '
          )}
        >
          {stepCount}
